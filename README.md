...
report.unauditableSequences; // carriers whose nested Data Sets were not reached. READ `.applied`:
// "emptied" = that content is NOT in your output; "kept" = it IS, verbatim, unaudited
