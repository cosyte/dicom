#!/usr/bin/env node
/**
 * Sync the `VERSION` constant in `src/version.ts` with `package.json`'s `version`.
 *
...
const srcUrl = new URL("src/version.ts", root);
...
if (!declaration.test(source)) {
  console.error(
    'sync-version: could not find `export const VERSION: string = "...";` in src/version.ts.\n' +
