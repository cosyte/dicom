...
| `FileMeta.transferSyntaxUID`                                                                   | A member of a closed set: the four native syntaxes and the PS3.5 2026c section A.4 encapsulation syntaxes. Any other value is a fatal, so no parsed dataset carries one.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
