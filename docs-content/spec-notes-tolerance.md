...
| `FileMeta.transferSyntaxUID`                                                                   | A member of a closed set: the four native syntaxes, the PS3.5 2026c section A.4 encapsulation syntaxes, and the four JPIP Referenced syntaxes of sections A.6, A.7, A.11 and A.12. Any other value is a fatal, so no parsed dataset carries one.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
