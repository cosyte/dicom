...
| `UnauditableSequenceFinding.tag` / `.byteLength`                                      | Composed, plus one input-derived number: `byteLength` is the size of the value that was dropped, never any of its bytes.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
