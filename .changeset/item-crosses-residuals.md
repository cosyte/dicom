...
`contextPath: ["53484E4F[0]"]`, which is `"HSON"` in wire order, and it is the **only** trace of that
header in the whole output. The claim is corrected in the type, the tolerance table and the
